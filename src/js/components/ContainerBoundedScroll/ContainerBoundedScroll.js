...
export default class ContainerBoundedScroll extends React.Component {
    static propTypes = {
    ...
    onTouchStart(ev) {
        this._touchStart = ev.touches[0].clientY;
        this._isScrolledAlready = false;
    }
    ...
    onScroll(ev) {
        ...
        const scrollDown = (ev.wheelDelta || -ev.deltaY || -ev.detail) < 0;
