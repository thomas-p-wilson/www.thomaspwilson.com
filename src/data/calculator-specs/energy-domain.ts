...
export const woodgasConversion: CalculatorSpec = {
  ...
  sections: [{
    title: "Conversion",
    fields: [
      { id: "gasoline", label: "Gasoline", unit: "gal", measure: "volume" },
      { id: "woodgasDensity", label: "Syngas Heating Value", unit: "BTU/m³" },
      { id: "gasBTU", label: "Gasoline Energy", unit: "BTU", readOnly: true },
      { id: "gasKJ", label: "Gasoline Energy", unit: "kJ", measure: "energy", readOnly: true },
      { id: "gasElectric", label: "Gasoline Energy", unit: "kWh", measure: "energy", readOnly: true },
      { id: "woodgas", label: "Equivalent Syngas Volume", unit: "m3", measure: "volume", readOnly: true },
      { id: "biomass", label: "Equivalent Biomass (15% moisture)", unit: "kg", measure: "mass", readOnly: true },
    ],
  }],
