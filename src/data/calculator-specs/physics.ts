...
export const idealGasLaw: CalculatorSpec = {
  ...
  sections: [{
    ...
    fields: [
      ...
      { id: "pressure", label: "Pressure", unit: "Pa", readOnly: (v) => v.solveFor === "pressure" },
      { id: "volume", label: "Volume", unit: "m³", readOnly: (v) => v.solveFor === "volume" },
      { id: "temperature", label: "Temperature", unit: "K", readOnly: (v) => v.solveFor === "temperature" },
...
export const centrifugalForce: CalculatorSpec = {
  ...
  sections: [{
    ...
    fields: [
      ...
      { id: "angularVelocity", label: "Angular Velocity (ω)", unit: "rad/s" },
